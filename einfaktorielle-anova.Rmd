...
Auch für einfaktorielle ANOVAs hat Rand @Wilcox.2012 natürlich wieder ein robustes Verfahren entwickelt und im Paket `WRS2` [@Mair.2020] implementiert. Die entsprechende Funktion ist für einfaktorielle Varianzanalysen `t1way()`.
